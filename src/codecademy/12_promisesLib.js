...
export const checkInventoryInitial = order => {
...
export const processPayment = responseArray => {
...
export const shipOrder = responseArray => {
    const order = responseArray[0]
...
export const checkAvailability = (itemName, distributorName) => {
