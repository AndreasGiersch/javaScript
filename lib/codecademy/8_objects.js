function objects() {
  ...
  let propName = 'Active Mission'; // Write your code below
  ...
  let retreatMessage = 'We no longer wish to conquer your planet. It is full of dogs, which we do not care for.'; // Write your code below
