...
function browserComp() {
  ...
  var carbonara = "You can make carbonara with ".concat(pasta, ", ").concat(meat, ", and a sauce made with ").concat(sauce, "."); // ES5 syntax only:

  var pasta1 = 'Spaghetti';
  var meat1 = 'Pancetta';
  var sauce1 = 'Eggs and cheese';
  var carbonara1 = 'You can make carbonara with ' + pasta1 + ', ' + meat1 + ', and a sauce made with ' + sauce1 + '.';
